...
export function PageLoader() {
  return (
    <div className="relative isolate -mx-4 -mt-4 flex min-h-[calc(100dvh+1rem)] items-center justify-center overflow-hidden bg-[#f5f5f7] px-6 py-10 text-gray-950 animate-fade-in dark:bg-[#050806] dark:text-white sm:-mx-6 sm:-mt-5 sm:min-h-[calc(100dvh+1.25rem)] lg:-mx-8">
