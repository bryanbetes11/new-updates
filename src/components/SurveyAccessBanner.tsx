...
export function SurveyAccessBanner() {
  ...
  return (
    <div className="mx-auto mt-3 flex max-w-7xl items-center gap-3 rounded-2xl border border-amber-300/35 bg-amber-50 px-4 py-3 text-amber-950 shadow-sm dark:border-amber-300/15 dark:bg-amber-300/[0.07] dark:text-amber-100">
