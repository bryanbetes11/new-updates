...
export function Library() {
  ...
  return (
    <div className="page-container page-bottom-pad overflow-x-clip">
      <div className="-mt-8 mx-auto max-w-2xl space-y-5 px-4 pt-0 sm:mt-0 sm:max-w-3xl sm:px-6 sm:pt-3 lg:max-w-5xl lg:px-8 lg:pt-4 xl:max-w-7xl 2xl:max-w-[1680px]">
