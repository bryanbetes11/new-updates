-- Re-create push_chat_message() with active_conversation_views suppression so
-- users who are actively viewing the conversation don't receive a web push
-- (they already see the message in real-time and get the in-app toast instead).
