-- Keep chat web push delivery server-side for all recipients. Foreground
-- suppression belongs in the service worker so visible app sessions get the
-- realtime toast while closed/background sessions still get lockscreen push.
