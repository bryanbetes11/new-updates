-- Let accountability drill-downs request the same quarter used by the summary.
-- Defaults preserve compatibility for any older client that requests all history.
drop function if exists public.get_member_attendance_history(uuid, integer);
