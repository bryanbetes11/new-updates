...
assert.equal(ANDROID_TEST_RELEASE.filename, 'ServeSync-1.4.1.apk');
assert.equal(ANDROID_TEST_RELEASE.build, 20);
assert.ok(ANDROID_TEST_RELEASE.url.includes('/android-v1.4.1-build20/'));
