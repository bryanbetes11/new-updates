...
assert.equal(ANDROID_TEST_RELEASE.filename, 'ServeSync-1.4.4.apk');
assert.equal(ANDROID_TEST_RELEASE.build, 23);
assert.ok(ANDROID_TEST_RELEASE.url.includes('/android-v1.4.4-build23/'));
