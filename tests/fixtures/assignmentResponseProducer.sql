-- Current producer snapshot for verifying migration compatibility without live notifications.
create function public.on_assignment_status_changed() returns trigger language plpgsql as $function$
declare
  v_event record;
  v_main_event record;
  v_user_name text;
